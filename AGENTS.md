...
- During every performance review, inspect allocations critically, especially vector, span, and other array-like construction or growth inside hot loops. Treat repeated allocation, resizing, copying, and transient views as explicit profiling targets; this codebase has repeatedly produced significant gains by removing such costs.
